...
function main() {
  ...
  modelsWorldMatrix[0] = utils.MakeWorld(0.5, 0.0, -4.0, 0.0, 0.0, 0.0, 1.0);
  modelsWorldMatrix[1] = utils.MakeWorld( 0.0, -1.0, -14.0, 0.0, 0.0, 0.0, 1.0);
  ...
  var viewMatrix = utils.MakeView(0.0, 2.0, 0.0, -5.0, 0.0);
  
  //------------------------------------------------------------------------------------------------
  var modelVertices = new Array();
  var modelNormals = new Array();
